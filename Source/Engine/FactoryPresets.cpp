...
constexpr std::array<Definition, kFactoryPresetCount> definitions {{
    ...
    { "33 VOCAL MORPH",   8, 8,  0,  0, .56, .52, -5, .00, 3100, .44, .62, .18, .82, .72, 1.20, 2.2, .06, .68, .64, 0, false },
    { "34 ARCADE BASS",   8, 8, -1, -1, .72, .44,  0, .00, 1800, .20, .66, .01, .18, .58, .16, 5.6, .00, .12, .34, 1, false },
    { "35 DIGITAL TOWER", 8, 8,  0,  1, .58, .42, 12, .01, 4700, .48, .46, .03, .44, .48, .65, 6.8, .04, .58, .62, 2, false },

    { "36 8BIT PULSE 12.5", 4, 0, -1,  0, .88, .00, 0, .00, 7200, .04, .08, .002, .08, .92, .04, 4.0, .00, .00, .08, 1, false },
    { "37 8BIT PULSE 25",   4, 0, -1,  0, .86, .00, 0, .00, 5600, .04, .10, .002, .10, .90, .05, 4.0, .00, .00, .08, 1, false },
    { "38 8BIT SQUARE 50",  4, 0, -1,  0, .84, .00, 0, .00, 4300, .03, .12, .002, .12, .88, .06, 4.0, .00, .00, .08, 1, false },
    { "39 8BIT PULSE 75",   4, 0, -1,  0, .86, .00, 0, .00, 5600, .04, .10, .002, .10, .90, .05, 4.0, .00, .00, .08, 1, false },
    { "40 TRIANGLE BASS",   2, 0, -1,  0, .90, .00, 0, .00, 1800, .08, .26, .004, .16, .82, .10, 3.2, .00, .00, .12, 1, false },

    { "41 UFO DRONE",     4, 4, -1, -1, .64, .52,  7, .04, 2400, .48, .20, .03, .30, .92, .80, 5.5, .10, .18, .64, 1, false },
    { "42 LASER FALL",    1, 4,  1,  0, .74, .36, 12, .00, 6200, .24, .54, .01, .08, .10, .18, 1.2, .10, .04, .36, 1, true  },
    { "43 LASER RISE",    4, 1,  0,  1, .70, .42, -9, .00, 7200, .18, .46, .01, .10, .08, .20, 1.0, .10, .06, .40, 1, true  },
    { "44 ALIEN SIREN",   1, 1, -1,  0, .66, .48,  5, .02, 3300, .58, .18, .02, .22, .86, .52, 7.0, .10, .12, .60, 1, false },
    { "45 INVADER STEP",  4, 2, -1, -1, .72, .30,  0, .03, 1800, .34, .72, .01, .08, .22, .10, 8.0, .08, .03, .46, 1, false },
    { "46 NOISE BURST",   0, 0,  0,  0, .00, .00,  0, .92, 8200, .10, .08, .001,.08, .00, .18, 6.0, .00, .24, .22, 0, false },
    { "47 EXPLOSION",     1, 0, -2,  0, .18, .00,  0, .88, 1650, .54, .76, .001,.65, .00, 1.40, 2.0, .04, .46, .72, 1, false },
    { "48 SPACE WIND",    0, 0,  0,  0, .00, .00,  0, .72, 2900, .62, .12, .35, 1.20, .72, 1.80, 0.35,.08, .74, .58, 0, false },
    { "49 ROBOT BLEEPS",  4, 4,  1,  2, .62, .34,  0, .02, 6900, .36, .30, .001,.10, .18, .12, 11.0,.10, .32, .48, 1, false },
    { "50 SPACE ALARM",   1, 4, -1,  0, .68, .38,  7, .06, 3900, .50, .26, .01, .18, .82, .44, 3.4, .10, .18, .66, 1, false }
}};
...
void configureCategoryDetails(FactoryPreset& preset, std::size_t index)
{
    ...
    {
        patch.filterKeyboardTracking = 0.2;
        patch.filterEnvelope = { 0.004, 0.16, 0.12, 0.10 };
        patch.lfoInitialAmount = 0.0;
        patch.stereoSpread = 0.0;
        patch.vintageAmount = 0.12;
    }
